...
#define DFMO_MAX_ANIMATION_BOOST_FREQ	(650000000)
#define DFMO_DEFAULT_ANIMATION_BOOST_FREQ	(480000000)
#define DFMO_OPENCL_BOOST_ON		(1)
#define DFMO_OPENCL_BOOST_DN		(0)
#define DFMO_MIN_OPENCL_BOOST_FREQ	(360000000)
#define DFMO_MAX_OPENCL_BOOST_FREQ	(650000000)
#define DFMO_DEFAULT_OPENCL_BOOST_FREQ	(480000000)
#define DFMO_MIN_HISPEED_FREQ		(120000000)
#define DFMO_MAX_HISPEED_FREQ		(650000000)
#define DFMO_DEFAULT_HISPEED_FREQ	(480000000)

#ifdef DFMO_REQUEST_QOS_CPU_DMA_LATENCY
#define DFMO_MIN_FREQ_FOR_QOS_CPU_DMA_LATENCY		(120000000)
#define DFMO_MAX_FREQ_FOR_QOS_CPU_DMA_LATENCY		(650000000)
#define DFMO_DEFAULT_FREQ_FOR_QOS_CPU_DMA_LATENCY	(650000000)
